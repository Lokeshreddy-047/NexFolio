      ...
      >
        {toasts.map((toast) => {
          ...
          const borderBgClass = isSuccess
            ? "border-emerald-500/30 bg-slate-900/95 dark:bg-slate-900/95 text-emerald-400 shadow-emerald-950/20"
            : isError
            ? "border-rose-500/30 bg-slate-900/95 dark:bg-slate-900/95 text-rose-400 shadow-rose-950/20"
            : isWarning
            ? "border-amber-500/30 bg-slate-900/95 dark:bg-slate-900/95 text-amber-400 shadow-amber-950/20"
            : "border-indigo-500/30 bg-slate-900/95 dark:bg-slate-900/95 text-indigo-400 shadow-indigo-950/20";
          ...
          return (
            <div
              key={toast.id}
              className={`pointer-events-auto flex items-start gap-3 p-4 rounded-2xl border shadow-xl backdrop-blur-md animate-in slide-in-from-bottom-3 duration-200 transition-all ${borderBgClass}`}
              role="alert"
            >
